...
using aspmvc73.Osoba;

namespace aspmvc73.Controllers
{
    public class OsobaController : Controller
    {
        private readonly OsobadbContext _context;

        public OsobaController(OsobadbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("OsobaId,Ime,Prezime,Adresa,DatumRodjenja,Telefon")] Osobe osoba)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OsobaId,Ime,Prezime,Adresa,DatumRodjenja,Telefon")] Osobe osoba)
        {
            if (id != osoba.OsobaId)
            {
                return NotFound();
